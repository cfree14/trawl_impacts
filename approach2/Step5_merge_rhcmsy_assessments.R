...
hab_key <- read.csv(file.path(saupdir, "SAUP_species_taxonomy_resilience.csv"), as.is=T)
ptrawl_key <- read.csv(file.path(saupdir, "saup_trawl_percent_key.csv"), as.is=T)
